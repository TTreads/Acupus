...
game.PlayScreen = me.ScreenObject.extend({
	...
	onResetEvent: function() {
		...
		me.game.HUD.addItem("score", new game.ScoreObject(200, 100));
		me.game.HUD.addItem("health", new game.HealthObject(30
			, 200));
...
game.CustomLoadScreen = me.ScreenObject.extend({
		...
		init : function() {
			this.parent(true);
			// melonJS logo
			this.logo1 = new me.Font('century gothic', 32, 'black', 'middle');
			this.logo2 = new me.Font('century gothic', 32, 'black', 'middle');
			this.logo2.bold();
		...
		draw : function(context) {
			...
			var logo1_width = this.logo1.measureText(context, "Acupus ").width;
			...
			// draw the logo
			this.logo1.draw(context, 'Acupus', xpos , ypos);
			xpos += logo1_width;
